...
const heracles = new Hero('👨 Heracles', 20, 6, './images/heracles.svg', {x: 5, y: 5});
...
const bird1 = new Monster('Bird', 25, 12, './images/bird.svg', {x: 8, y: 2});
const bird3 = new Monster('Bird', 25, 12, './images/bird.svg', {x: 4, y: 9});
const bird2 = new Monster('Bird', 25, 12, './images/bird.svg', {x: 5, y: 1});
